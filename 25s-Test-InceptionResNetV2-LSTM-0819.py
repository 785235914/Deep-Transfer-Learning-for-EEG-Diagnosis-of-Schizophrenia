...
# lstm_best_model.save('LabTestModel25s/224-InceptionResNetV2-Lstm-Best-Model.h5')
...
lstm_best_model.save('ModelROCPlots/InceptionResNetV2(0.86)-LSTM_Best_Model(224-25s).h5')
...
# 保存图像
plt.savefig(f'{save_path}/InceptionResNetV2(0.86) - Receiver Operating Characteristic.png')
...
# 保存图像
plt.savefig(f'{save_path}/InceptionResNetV2(0.86) - Precision-Recall curve.png')
