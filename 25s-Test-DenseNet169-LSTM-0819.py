...
random_search_lstm.best_estimator_.model.save('LabTestModel25s/224-DenseNet169-Lstm-Random-Model.h5')
...
lstm_best_model.save('LabTestModel25s/224-DenseNet169-Lstm-Best-Model.h5')
...
lstm_best_model.save('ModelROCPlots/DenseNet169(0.88)-LSTM_Best_Model(224-25s).h5')
...
save_path = '/Users/yuanyi/学习/毕业论文/毕业论文题目/Pycharm_Code/LabTestModel25s'
# 保存图像
plt.savefig(f'{save_path}/DenseNet169(0.88) - Receiver Operating Characteristic.png')
...
# 保存图像
plt.savefig(f'{save_path}/DenseNet169(0.88) - Precision-Recall curve.png')
...
# DenseNet169
# Train Loss:  0.002301604487001896
# Train Accuracy:  1.0
# Validation Loss:  0.5528627634048462
# Validation Accuracy:  0.8833819031715393
# Best NASNetMobile-25s parameters:  {'units': 128, 'recurrent_dropout': 0.2, 'optimizer': 'rmsprop', 'learning_rate': 0.001, 'epochs': 50, 'dropout': 0.2, 'batch_size': 64, 'activation': 'sigmoid'}
# Best NASNetMobile-25s accuracy:  0.9549367070198059
# Accuracy:  0.8833819241982507
# F1 Score:  0.900990099009901
# AUC:  0.8780769230769232
