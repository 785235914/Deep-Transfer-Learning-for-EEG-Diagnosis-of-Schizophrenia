...
random_search_lstm.best_estimator_.model.save('LabTestModel25s/256-NASNetMobile-Lstm-Random-Model-25s.h5')
...
lstm_best_model.save('LabTestModel25s/256-NASNetMobile-Lstm-Best-Model-25s.h5')
# lstm_best_model.save('ModelROCPlots/NASNetMobile-LSTM_Best_Model(256-25s).h5')
...
# best_model = load_model('/Users/yuanyi/学习/毕业论文/毕业论文题目/Pycharm_Code/TestModel/224-MobieNet-LSTM_Best_Model-l1.h5')
...
plt.title('NASNetMobile-Receiver Operating Characteristic')
plt.legend(loc="lower right")

save_path = '/Users/yuanyi/学习/毕业论文/毕业论文题目/Pycharm_Code/ModelROCPlots'
# 保存图像
plt.savefig(f'{save_path}/NASNetMobile - Receiver Operating Characteristic.png')
...
plt.figure()
# plt.plot(precision_train, recall_train, color='red', label='train - Precision-Recall Curve')
plt.plot(recall, precision, label='valid - Precision-Recall Curve')
plt.xlabel('Recall')
plt.ylabel('Precision')
plt.title('NASNetMobile - Precision-Recall curve')
plt.legend(loc="lower left")

save_path = '/Users/yuanyi/学习/毕业论文/毕业论文题目/Pycharm_Code/ModelROCPlots'
# 保存图像
plt.savefig(f'{save_path}/NASNetMobile-2 - Precision-Recall Curve.png')
...
#
# NASNetMobile
# Train Loss:  0.3696655035018921
# Train Accuracy:  0.9111389517784119
# Validation Loss:  1.0836753845214844
# Validation Accuracy:  0.7696793079376221
...
# Best NASNetMobile-25s accuracy:  0.9261867105960846
#
# Accuracy:  0.7696793002915452
# F1 Score:  0.7926509186351707
# AUC:  0.7717580960357342
