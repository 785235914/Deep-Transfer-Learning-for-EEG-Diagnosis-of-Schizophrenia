...
random_search_lstm.best_estimator_.model.save('Model/224-MobieNet-Random-Model-0811.h5')
...
lstm_best_model.save('Model/224-MobieNet-LSTM-0811.h5')
...
print("Best MobieNet-CNN parameters: ", random_search_lstm.best_params_)
print("Best MobieNet-CNN accuracy: ", random_search_lstm.best_score_)
...
# 224-MobieNet BatchNormalization
# Train Loss:  3.0655835871584713e-05
# Train Accuracy:  1.0
# Validation Loss:  0.5306854844093323
# Validation Accuracy:  0.909621000289917
# Best MobieNet-CNN parameters:  {'units': 128, 'recurrent_dropout': 0.2, 'optimizer': 'rmsprop', 'learning_rate': 0.001, 'epochs': 100, 'dropout': 0.2, 'batch_size': 128, 'activation': 'sigmoid'}
# Best MobieNet-CNN accuracy:  0.9962500035762787
# Accuracy:  0.9766763848396501
# F1 Score:  0.9792746113989638
# AUC:  0.9763039723661485
